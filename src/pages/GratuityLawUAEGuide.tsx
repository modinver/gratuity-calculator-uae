          ...
          <div className="container mx-auto px-4 py-12 sm:px-6 lg:px-8">
            <div className="max-w-4xl mx-auto">
              ...
              <section id="section-1" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">What is Gratuity?</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Purpose of Gratuity</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">The primary purposes of gratuity payments are:</p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Providing financial support to employees after the end of their employment.</li>
                    <li>Rewarding loyalty and long-term service to the company.</li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Legal Basis of Gratuity in the UAE</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Applicability</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <section id="section-2" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Federal Decree Law No. 33 of 2021</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Key Provisions:</h4>
                  ...
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Ensures timely payment of gratuity within two weeks of termination.</li>
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Employer Obligations</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">Employers are legally obligated to:</p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Accurately calculate gratuity benefits and ensure timely payments.</li>
                    <li>Failure to comply can lead to legal penalties.</li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Comparison with Payment of Gratuity Act 1972</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">International Perspectives</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <section id="section-3" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Gratuity Calculation Formula</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">Calculating gratuity in the UAE is straightforward:</p>
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Maximum Limit</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h4 className="text-lg font-medium text-gray-800 mt-6 mb-3">Components of Gratuity Calculation</h4>
                  <p className="text-gray-700 leading-relaxed mb-4">The calculation revolves around the basic salary alone. Essential considerations include:</p>
                  <ul className="mb-6 text-gray-700">
                    <li className="mb-4">
                      <strong>Basic Salary</strong>:
                      <ul className="list-disc pl-6 mt-2">
                        <li className="mb-2">Gratuity is computed based on the last basic salary only, excluding any benefits like transportation or housing allowances.</li>
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Detailed Calculation Examples</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">To clarify the calculation process, here are two examples:</p>
                  <ul className="mb-6 text-gray-700">
                    <li className="mb-4">
                      <strong>Example 1</strong>: An employee with a basic salary of AED 10,000 and 3 years of service.
                      <ul className="list-disc pl-6 mt-2">
                        <li className="mb-2">Daily wage = AED 10,000 / 30 = AED 333.33.</li>
                    ...
                    <li>
                      ...
                      <ul className="list-disc pl-6 mt-2">
                        <li className="mb-2">First five years: 21 days × AED 400 × 5 = AED 42,000.</li>
                        <li className="mb-2">Remaining two years: 30 days × AED 400 × 2 = AED 24,000.</li>
                        <li>Total Gratuity = AED 42,000 + AED 24,000 = AED 66,000.</li>
                      </ul>
                    </li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Factors Influencing Gratuity Amount</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">Several factors may influence the total gratuity amount, including:</p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Unpaid leave can be excluded from total service length.</li>
              ...
              <section id="section-4" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Employment Contract Types in the UAE</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Limited (Fixed-Term) Contracts:</h4>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Limited contracts have specified start and end dates.</li>
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Gratuity for Limited Contracts</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Entitlement:</h4>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Impact of Resignation or Termination</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Resignation:</h4>
                  <p className="text-gray-700 leading-relaxed mb-6">
                    Employees still receive full gratuity rights after a year, with no penalties for resigning.
                  </p>
                  
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Termination:</h4>
                  <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <section id="section-5" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Eligibility Criteria</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Minimum Service Period:</h4>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Components Excluded from Gratuity</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Excluded Allowances:</h4>
                  <p className="text-gray-700 leading-relaxed mb-4">
                    Gratuity calculations are strictly based on the employee's basic salary. The following allowances are excluded:
                  </p>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Housing allowance</li>
                    <li className="mb-2">Transportation allowance</li>
                    <li className="mb-2">Overtime pay</li>
                    <li>Other perks</li>
                  </ul>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Exceptions and Special Cases</h3>
                  <ul className="mb-6 text-gray-700">
                    <li className="mb-4">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Payment Timelines</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <section id="section-6" className="scroll-mt-24">
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">For Employees</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Understanding Your Rights:</h4>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Every employee is eligible for gratuity after completing one year of service.</li>
                    <li className="mb-2">Remember that gratuity is based on the last basic salary, excluding allowances.</li>
                    <li>Resignation does not affect entitlement under the new law.</li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Action Points:</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Maintain records of employment duration and salary details.</li>
                    <li>Consult HR for clarity around gratuity calculations.</li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">For Employers</h3>
                  <h4 className="text-lg font-medium text-gray-800 mb-3">Compliance Obligations:</h4>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Ensure accurate calculations and timely gratuity disbursements.</li>
                    <li>Familiarize yourself with the latest labor laws to maintain compliance.</li>
                  </ul>
                  
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Best Practices:</h3>
                  <ul className="list-disc pl-6 mb-6 text-gray-700">
                    <li className="mb-2">Maintain transparent communication with employees regarding end-of-service benefits.</li>
              ...
              <section>
                ...
                <div className="prose max-w-none mb-10">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Encouragement to Stay Informed</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
              ...
              <section>
                ...
                <div className="prose max-w-none mb-10">
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Engage with Readers</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
                  ...
                  <h3 className="text-xl font-semibold text-gray-800 mt-8 mb-4">Resources and Assistance</h3>
                  <p className="text-gray-700 leading-relaxed mb-6">
